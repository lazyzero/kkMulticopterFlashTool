...
package de.lazyzero.kkMulticopterFlashTool.utils.xml;
...
//    }
     ...
     */
    public void write(Writer writer, int indentation)
        throws IOException
    {
        if (this.name == null) {
        ...
        if ((this.contents != null) && (this.contents.length() > 0)) {
            ...
            writer.write(">\n");
            Enumeration enums = this.enumerateChildren();
            while (enums.hasMoreElements()) {
                XMLElement child = (XMLElement) enums.nextElement();
                child.write(writer, indentation+2);
            }
            indentate(writer, indentation);
            writer.write('<'); writer.write('/');
            writer.write(this.name);
    ...
    private void indentate(Writer writer, int indentation) throws
    IOException {
